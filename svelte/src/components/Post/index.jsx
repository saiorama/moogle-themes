  ...
  return (
    <div className="columns">
      ...
      <div className="column is-three-fifths mx-4">
        ...
        <div className="blog content" dangerouslySetInnerHTML={markup(postContent && postContent.html && postIsLive(postMeta) ? postContent.html : '<a href="/" class="button is-primary is-light">Back</a>')}>
        </div>
        {/* <Comments /> */}
        <br />
      </div>
