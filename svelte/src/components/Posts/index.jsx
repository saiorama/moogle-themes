      ...
      <div className="column is-three-fifths">
        <article class="media mt-4 pt-4 mx-2">
          ...
          <div class="container has-background-info">
            <div class="container content is-success">
              <p>
            ...
            <nav class="level is-mobile">
              <div class="icon-has-text-info" style={{backgroundColor:"white",padding:"8px 8px",borderRadius:"32px"}}>
                        ...
                        <li className="my-6 mx-3" id={postId} key={index + 1}> 
                          <article class="media">
                            ...
                            <div class="media-content">
                              <div class="content">
                                <div className="flex">
                                  <h4 className="postTitle is-family-secondary is-size-5 is-marginless" style={{width: '78%',textDecoration: 'none'}}>{post.post_title}</h4>
                                  <span className="postDate" style={{width: '22%',textDecoration: 'none'}}>{convertTime(post.published_unix_ts)}</span>
                                </div>
                                <br/>
                                <p className="is-size-6" style={{textDecoration: 'none'}}> {post.post_excerpt.substring(0,100)}... </p>
                                <small class="button is-success is-outlined"> Read More... </small>
                              </div>
